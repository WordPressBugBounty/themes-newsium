...
class AdminNotice
{
  ...
  function newsium_dashboard_notice_content()
  {
    ...
    $notice_starter_msg = sprintf(
      ...
      __('Explore Our Pre-Built Starter Websites!', 'newsium'),
      esc_html__('Let your imagination soar! Designed with User-Friendly features, incorporating the Latest Trends and SEO-Friendly Markups. We genuinely appreciate you choosing our theme!', 'newsium'),
      $newsium_templatespare_url,
