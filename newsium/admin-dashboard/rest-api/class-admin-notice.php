...
class AdminNotice {
    ...
    function newsium_dashboard_notice_content(){
		...
		$notice_starter_msg =sprintf(
			...
			esc_html__( 'Let your imagination soar! Expert Designed Templates with User-Friendly features, incorporating the Latest Trends and SEO-Friendly Markups. We genuinely appreciate you choosing our theme!', 'newsium' ),
			$af_companion_url,
			$af_companion_title,
			esc_url($demo_link),
