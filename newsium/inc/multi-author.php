<?php 
if(!function_exists('newsium_by_author')){
    function newsium_by_author(){
        global $post;
            ...
            if(isset($awpa_post_authors) && !empty($awpa_post_authors && $multiauthor_settings == true)){
                foreach ($awpa_post_authors as $key=>$author_id) {
                    ...
                    if (strpos($author_id, $needle) !== false) {
                     ...
                     newsium_author_list($post_id,$author_id,$author_type, $author_avatar=false);
...
if(!function_exists('newsium_author_list')){
function newsium_author_list($post_id='',$author_id='',$author_type='',$author_avatar=false){
